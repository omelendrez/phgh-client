    ...
    <v-container>
      <v-card-text>
        <v-form v-model="valid" ref="form">
          ...
          <v-text-field prepend-icon="group_work" v-model="user.referrerUsername" label="Referral" type="text" :disabled="!!referrer"></v-text-field>
          ...
          <v-text-field prepend-icon="phone" v-model="user.phone" label="Phone" type="phone" :rules="[rules.required, rules.isPhone]" hint="Enter your phone number" :mask="rules.maskPhone"></v-text-field>
